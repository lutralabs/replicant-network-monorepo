...
function SidebarInset({ className, ...props }: React.ComponentProps<'main'>) {
  return (
    <main
      className={cn(
        'bg-slate-100 relative flex min-h-svh flex-1 flex-col',
...
const sidebarMenuButtonVariants = tv({
  ...
  variants: {
    variant: {
      ...
      outline:
        'bg-slate-100 shadow-[0_0_0_1px_hsl(var(--sidebar-border))] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground hover:shadow-[0_0_0_1px_hsl(var(--sidebar-accent))]',
    },
    size: {
      default: 'h-8 text-sm',
      sm: 'h-7 text-xs',
